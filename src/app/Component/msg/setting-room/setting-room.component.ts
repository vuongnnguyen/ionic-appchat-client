...
import { ChatServicesService, room } from '../../Services/chat-services.service';
import { ModalController } from '@ionic/angular';
import { AddmemberComponent } from './addmember/addmember.component';
import { objUser } from '../../render/viewmessage/viewmessage.component';
...
export class SettingRoomComponent implements OnInit {
  ...
  leaveRoom() {
    ...
    this._services.managementRoom(obj, 'https://vuongdeptrai.herokuapp.com/user/leave-room')
    .then( res => {
  ...
  showRoom() { 
    ...
    this._services.managementRoom(obj, 'https://vuongdeptrai.herokuapp.com/user/show-room')
